...
cmd({
  ...
  alias: ["upgrade", "sync"],
  react: '🧠',
  desc: "Update FAITH-MD bot from GitHub.",
  category: "system",
  filename: __filename
  ...
  try {
    await reply("🔎 Checking for FAITH-MD updates...");

    const repo = "ZEZETECH47/FAITH-MD";
    ...
    if (latestHash === currentHash) {
      return reply("✅ You are already using the latest version of FAITH-MD!");
    }
    ...
    const sourcePath = path.join(extractPath, "FAITH-MD-main");
